    ...
    <div className="flex flex-col gap-8 w-full pb-10">
      ...
      <div>
        ...
        <p className="text-[15px] text-gray-500 mb-5">
          Configure election operations, security, notifications, integrations, and system policies.
        </p>
        <div className="flex items-center text-[15px] font-semibold text-gray-600 mb-2">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-6 flex flex-col hover:shadow-sm transition-shadow">
          ...
          <h2 className="text-[15px] font-semibold text-[#005fb0] mb-2">Election Configuration</h2>
          ...
          <div className="border-t border-[#e4e7ec] pt-4 mt-auto">
            <button className="flex items-center text-[14px] font-semibold text-[#005fb0] hover:text-[#004786]">
              Configure <MaterialIcon icon="arrow_forward" className="ml-1 text-[16px]" />
            </button>
          </div>
        </div>
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-6 flex flex-col hover:shadow-sm transition-shadow">
          ...
          <h2 className="text-[15px] font-semibold text-[#005fb0] mb-2">Security & Access</h2>
          <p className="text-[14px] text-gray-500 mb-6 flex-1">
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-6 flex flex-col hover:shadow-sm transition-shadow">
          ...
          <h2 className="text-[15px] font-semibold text-[#005fb0] mb-2">Operational Protocols</h2>
          <p className="text-[14px] text-gray-500 mb-6 flex-1">
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-6 flex flex-col hover:shadow-sm transition-shadow">
          ...
          <h2 className="text-[15px] font-semibold text-[#005fb0] mb-2">Notifications & Alerts</h2>
          <p className="text-[14px] text-gray-500 mb-6 flex-1">
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-6 flex flex-col hover:shadow-sm transition-shadow">
          ...
          <h2 className="text-[15px] font-semibold text-[#005fb0] mb-2">Data & Integrations</h2>
          <p className="text-[14px] text-gray-500 mb-6 flex-1">
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-6 flex flex-col hover:shadow-sm transition-shadow">
          ...
          <h2 className="text-[15px] font-semibold text-[#005fb0] mb-2">Audit & Compliance</h2>
          <p className="text-[14px] text-gray-500 mb-6 flex-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white border border-[#e4e7ec] rounded-lg p-5 flex items-center hover:shadow-sm transition-shadow">
          ...
          <div className="flex-1">
            <h3 className="text-[15px] font-semibold text-[#005fb0]">Public Information</h3>
